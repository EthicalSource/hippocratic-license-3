...
export class ModuleListItem extends HTMLElement {
  constructor() {
    ...
    this.findButton.setAttribute('part', 'button')

    this.findButton.innerHTML = `<svg part="button-icon" title="" xmlns="http://www.w3.org/2000/svg" class="" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
    </svg>`

    this.infoButton = cr('button')
    this.infoButton.setAttribute('part', 'button')
    this.infoButton.innerHTML = `<svg part="button-icon" style="fill:currentColor;" title="" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20">
